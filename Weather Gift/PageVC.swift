...
class PageVC: UIPageViewController {
    ...
    var currentPage = 0
    var locationsArray = ["Local City", "Sydney", "Accra", "Uglich"]
    ...
    private func configurePageControl() {
        let pageControlHeight = barButtonHeight
    ...
    private func configureListButton() {
        ...
        listButton.setBackgroundImage(#imageLiteral(resourceName: "listButton"), for: .normal)
        listButton.setBackgroundImage(#imageLiteral(resourceName: "listButton-highlighted"), for: .highlighted)
    ...
    private func createDetailVC(forPage page: Int) -> DetailVC {
        currentPage = min(max(0, page), locationsArray.count - 1)
        
        let detailsVC = storyboard!.instantiateViewController(withIdentifier: "DetailVC") as! DetailVC
        detailsVC.currentPage = currentPage
        detailsVC.locationsArray = locationsArray
